...
const Home = () => {
  return (
    <div className="bg-white h-screen flex justify-between px-20 py-15 object-contain ">
      <div>
        <h1 className=" font-bold text-7xl text-yellow-900">
          Book your
          <br />
        </h1>
        <h1 className=" font-bold text-7xl text-yellow-900">
        ...
        <h1 className=" font-bold text-7xl text-blue-400 ">
          Appointment
          <br />
        </h1>
        <h1 className=" font-bold text-7xl text-yellow-900">
        ...
        <div className="">
          <h1>✔ Certified, experienced groomers & vets</h1>
          <h1>✔ Flexible morning & afternoon time slots</h1>
          <h1>✔ Anxiety-free environment for all pets</h1>
          <h1>✔ All breeds and pet types welcome</h1>
        </div>
      </div>
      <div>
        <img
          className="w-140 h-140 rounded-4xl  "
