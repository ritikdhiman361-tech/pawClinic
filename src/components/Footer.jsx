        ...
        <div className="grid grid-cols-3 gap-12 mb-10">
          ...
          <div className="">
            ...
            <p className="text-zinc-300 text-sm leading-relaxed mb-5">
              Caring for your pets with love and expertise. <br /> Book appointments, track visits, and keep <br /> your furry friends healthy.
            </p>
            </div>
          ...
          <div className = "flex flex-col px-30">
            <p className="text-amber-100 text-xs font-semibold uppercase tracking-widest align-super mb-6  ">Contact</p>
